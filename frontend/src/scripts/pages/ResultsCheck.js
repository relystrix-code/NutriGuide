const ResultsCheck = {
  async render() {
    ...
    if (bmi < 18.5) {
      ...
      articles = [
        {
          title: 'Tips Meningkatkan Berat Badan',
          link: '#/article/1',
          date: '1/12/2024',
        },
        {
          title: 'Nutrisi Penting untuk Tubuh Kurus',
          link: '#/article/2',
          date: '2/12/2024',
        },
        {
          title: 'Cara Meningkatkan Selera Makan',
          link: '#/article/3',
          date: '3/12/2024',
        },
      ];
      ...
      articles = [
        {
          title: 'Pola Hidup Sehat untuk Mempertahankan Berat',
          link: '#/article/4',
          date: '1/12/2024',
        },
        {
          title: 'Olahraga Rutin untuk Hidup Seimbang',
          link: '#/article/5',
          date: '2/12/2024',
        },
        {
          title: 'Tips Nutrisi untuk Gaya Hidup Aktif',
          link: '#/article/6',
          date: '3/12/2024',
        },
      ];
      ...
      articles = [
        {
          title: 'Cara Efektif Menurunkan Berat Badan',
          link: '#/article/7',
          date: '1/12/2024',
        },
        {
          title: 'Makanan Rendah Kalori yang Enak dan Sehat',
          link: '#/article/8',
          date: '2/12/2024',
        },
        {
          title: 'Panduan Olahraga untuk Menurunkan Berat Badan',
          link: '#/article/9',
          date: '3/12/2024',
        },
      ];
      ...
      articles = [
        {
          title: 'Langkah-langkah Awal untuk Melawan Obesitas',
          link: '#/article/11',
          date: '1/12/2024',
        },
        {
          title: 'Pentingnya Konsultasi dengan Ahli Gizi',
          link: '#/article/12',
          date: '2/12/2024',
        },
        {
          title: 'Olahraga yang Aman untuk Pengidap Obesitas',
          link: '#/article/13',
          date: '3/12/2024',
        },
      ];
